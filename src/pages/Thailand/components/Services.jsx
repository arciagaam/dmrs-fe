...
const Services = ({ name, icon, subContents }) => {
  ...
  return (
    ...
    >
      ...
      <span className={`absolute top-16 -right-[10%] z-0 ${isActive ? 'opacity-25 scale-125 ease-in-out duration-200' : ''} -top-[20%] -right-[30%] scale-[0.7] mobile:scale-[0.7] mobile:-right-[20%] mobile:top-[0%] tablet:top-0 tablet:-right-[30%] laptop:scale-[0.8] laptop:-right-[4rem] laptop:top-[20%]`}>{icon}</span>
