...
const TermsAndConditions = () => {
  const paragraphs = [
    ...
    },
    {
      ...
      content:'Your use of the site is subject to all applicable laws and regulations, and you are solely responsible for the substance of your communications through the site. By posting information in or otherwise using any communications service, chat room, message board, newsgroup, software library, or other interactive service that may be available to you on or through this site, you agree that you will not upload, share, post, or otherwise distribute or facilitate distribution of any content -- including text, communications, software, images, sounds, data, or other information -- that:', 
      subParagraph: [
        {
        ...
        {
          content: "victimizes, harasses, degrades, or intimidates an individual or group of individuals on the basis of religion, gender, sexual orientation, race, ethnicity, age, or disability;",
        },
        {
          content: "infringes on any patent, trademark, trade secret, copyright, right of publicity, or other proprietary right of any party;",
        },
        {
          content: "constitutes unauthorized or unsolicited advertising, junk or bulk email (also known as \"spamming\"), chain letters, any other form of unauthorized solicitation, or any form of lottery or gambling;",
        },
        {
          content: "contains software viruses or any other computer code, files, or programs that are designed or intended to disrupt, damage, or limit the functioning of any software, hardware, or telecommunications equipment or to damage or obtain unauthorized access to any data or other information of any third party; or",
        },
        {
          content: " impersonates any person or entity, including any of our employees or representatives.",
        }
      ]
    },
    {
    ...
    },
    {
      ...
      content:(
        <>
          Copyright (c) 1st. July 2011 Dan Murdoch Risk Services All Rights Reserved.
          <br />
          <br />
    ...
    },
    {
      ...
      subParagraph: [
        {
          content: "Identify in sufficient detail the copyrighted work that you believe has been infringed upon or other information sufficient to specify the copyrighted work being infringed).",
        },
        {
          content: "Identify the material that you claim is infringing the copyrighted work listed in item #1 above.",
        },
        {
          content: "Provide information reasonably sufficient to permit us to contact you (email address is preferred).",
        },
        {
          content: "Provide information, if possible, sufficient to permit us to notify the owner/administrator of the allegedly infringing webpage or other content (email address is preferred).",
        },
        {
          content: "Include the following statement: \"I have a good faith belief that use of the copyrighted materials described above as allegedly infringing is not authorized by the copyright owner, its agent, or the law.\"",
        },
        {
          content: " Include the following statement: \"I swear, under penalty of perjury, that the information in the notification is accurate and that I am the copyright owner or am authorized to act on behalf of the owner of an exclusive right that is allegedly infringed.\"",
        },
        {
          content: "Sign the paper.",
        },
        {
          content: "Send the written communication to the following address:Designated Agent for Claimed Infringement:You acknowledge and agree that upon receipt of a notice of a claim of copyright infringement, we may immediately remove the identified materials from our site without liability to you or any other party and that the claims of the complaining party and the party that originally posted the materials will be referred to the United States Copyright Office for adjudication as provided in the Digital Millennium Copyright Act.",
        },
      ]
    },
    {
    ...
    },
    {
      ...
      content:"You are solely responsible for maintaining the confidentiality of your password and account and for any and all statements made and acts or omissions that occur through the use of your password and account. Therefore, you must take steps to ensure that others do not gain access to your password and account. Our personnel will never ask you for your password. You may not transfer or share your account with anyone, and we reserve the right to immediately terminate your account if you do transfer or share your account."
    },
    {
    ...
    },
    {
      ...
      content:"Although this site may be accessible worldwide, we make no representation that materials on this site are appropriate or available for use in locations outside the United States, and accessing them from territories where their contents are illegal is prohibited. Those who choose to access this site from other locations do so on their own initiative and are responsible for compliance with local laws. Any offer for any product, service, and/or information made in connection with this site is void where prohibited."
    },
    {
    ...
    },
    {
      ...
      content:"Except as explicitly noted on this site, the services available through this site are offered by Dan Murdoch Risk Services,located in Australia. If you notice that any user is violating these Terms of Use, please contact us at info@yourintell.com."
    }
  ]
  ...
  return (
    <section className='navTrigger'>
      ...
      <div className='flex flex-col w-full gap-6 px-6 py-24 bg-white h-fit mobile:py-24 mobile:p-12 mobile:h-fit mobile:flex-col tablet:p-24 tablet:flex-col laptop:px-20 laptop:py-20 laptop:gap-12 desktop:gap-10 desktop:p-36'>
        <div>
          <h1 className='z-10 text-xl font-bold mobile:text-left mobile:text-2xl tablet:text-2xl'>TERMS OF USE</h1>
          <h2 className='z-10 text-sm font-bold text-accent-800 mobile:text-left mobile:text-base tablet:text-base'>Dan Murdoch Risk Services</h2>
        </div>
        <h2 className='z-10 text-sm font-bold mobile:text-left mobile:text-base tablet:text-base'>SITE TERMS AND CONDITIONS USE</h2>
        <ol className='flex flex-col gap-6 pl-5 list-decimal'>
          {paragraphs.map((item, index) => <Paragraph key={index} title={item.title} content={item.content} subParagraph={item.subParagraph ?? ''} /> )}
        </ol>
      </div>
    </section>
    </section>
