...
const TermsAndConditions = () => {
  const paragraphs = [
    {
      title: "User's Acknowledgment and Acceptance of Terms",
      content: (
        <>
          <p>
            Dan Murdoch Risk Services ("Us" or "We") provides the yourintell.com
            ...
            shall be subject to any posted rules applicable to such services or
            materials that may contain terms and conditions in addition to those
            in these Terms of Use. All such guidelines or rules are hereby
          ...
          <p>
            These Terms of Use are effective as of 1st. July 2011. We expressly
            ...
            responsibility to review this site and these Terms of Use from time
            to time and to familiarize yourself with any modifications. Your
            continued use of this site after such modifications will constitute
            acknowledgment of the modified Terms of Use and agreement to abide
    ...
    },
    {
      ...
      content: (
        <>
          <p>We make various services available on this site including, but not
          limited to, Intelligence gathering, data collection, investigation
          services, internet research, research, online services, and other like
          ...
          and Internet access (including payment of all fees associated with
          such access).</p>

          <p>We reserve the sole right to either modify or discontinue the site,
    ...
    {
      title: "Registration Data and Privacy",
      content: (
        <>
          <p>In order to access some of the services on this site, you will be
          ...
          required in order to keep it current, complete, and accurate.</p>

          <p>You also grant us the right to disclose to third parties certain
    ...
    {
      title: "Third Party Sites and Information",
      content:
    ...
    },
    {
      ...
      content: (
        <>
          <p>Copyright (c) 1st. July 2011 Dan Murdoch Risk Services All Rights
          Reserved.</p>

          <p>For purposes of these Terms of Use, "content" is defined as any
          ...
          <p>By accepting these Terms of Use, you acknowledge and agree that all
          ...
          laws, and is the sole property of Dan Murdoch Risk Services and/or its
          ...
          <p>Neither we or our Affiliates warrant or represent that your use of
          ...
          other proprietary right of any party.</p>

          <p>All custom graphics, icons, logos and service names are registered
          trademarks, trademarks or service marks of Dan Murdoch Risk Services
          or its Affiliates. All other trademarks or service marks are property
          of their respective owners. Nothing in these Terms of Use grants you
          any right to use any trademark, service mark, logo, and/or the name of
          Dan Murdoch Risk Services or its Affiliates.</p>
        </>
      ),
    },
    {
      title: " Unauthorized Use of Materials",
      content: (
        <>
          <p>Subject to our Privacy Policy, any communication or material that you
          ...
          or not currently known) in which it is used.</p>

          <p>Please do not submit confidential or proprietary information to us
          ...
          submit them to us in any circumstance.</p>

          <p>We respect the intellectual property of others, and we ask you to do
    ...
    },
    {
      ...
      content: (
        <>
          ...
          UPDATE SUCH MATERIALS OR SERVICES.</p>
          ...
          <p>Through your use of the site, you may have the opportunities to engage
          ...
          or statement made by anyone other than an authorized Dan Murdoch Risk
          Services spokesperson speaking in his/her official capacity. Please
          refer to the specific editorial policies posted on various sections of
          this site for further information, which policies are incorporated by
    ...
    },
    {
      ...
      content: (
        <>
          ...
          OF THIS SITE OR OF ANY WEB SITE REFERENCED OR LINKED TO FROM THIS SITE.</p>
    ...
    {
      title: "E-mail, Messaging, Blogging, and Chat Services",
      content: (
        <>
          <p>We may make email, messaging, blogging, or chat services
          ...
          contradictory, includes these Terms.</p>
          ...
          governmental order. Further information is available in our Privacy Policy.</p>

          <p>We may employ automated monitoring devices or techniques to protect
          ...
          communication that is not blocked.</p>

          <p>Mailboxes may have a limited storage capacity. If you exceed the
          ...
          responsible for such deleted or blocked messages.</p>
        </>
      ),
    },
    {
    ...
    },
    {
      ...
      content: (
        <>
          <p>You agree that we may, in our sole discretion, terminate or suspend
          ...
          appropriate law enforcement authorities.</p>

          <p>Upon termination or suspension, regardless of the reasons therefore,
    ...
    },
    {
      ...
      content: (
        <>
          <p>In any action to enforce these Terms of Use, the prevailing party will
          ...
          <p>You may not assign your rights and obligations under these Terms of
          ...
          <p>You agree not to sell, resell, reproduce, duplicate, copy or use for
          any commercial purposes any portion of this site, or use of or access
          to this site.In addition to any excuse provided by applicable law, we
          shall be excused from liability for non-delivery or delay in delivery
          ...
          <p>If any part of these Terms of Use is held invalid or unenforceable,
          ...
          effect.Any failure by us to enforce or exercise any provision of these
    ...
    },
    {
      ...
      content:
        "Except as explicitly noted on this site, the services available through this site are offered by Dan Murdoch Risk Services,located in Australia. If you notice that any user is violating these Terms of Use, please contact us at info@yourintell.com.",
    },
  ];
  ...
  return (
    <section className="navTrigger">
      <section className="navTrigger">
        <div className="flex flex-col w-full gap-6 px-6 py-24 bg-white h-fit mobile:py-24 mobile:p-12 mobile:h-fit mobile:flex-col tablet:p-24 tablet:flex-col laptop:px-20 laptop:py-20 laptop:gap-12 desktop:gap-10 desktop:p-36">
          <div>
            <h1 className="z-10 text-xl font-bold mobile:text-left mobile:text-2xl tablet:text-2xl">
              TERMS OF USE
            </h1>
            <h2 className="z-10 text-sm font-bold text-accent-800 mobile:text-left mobile:text-base tablet:text-base">
