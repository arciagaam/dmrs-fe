    ...
    <div className="flex flex-col w-full bg-white">
      ...
      <div className="flex">
        <div className="flex flex-col flex-1 sticky top-16 items-center justify-center max-h-[calc(100vh-4rem)] gap-1">
          ...
          <p className='text-center text-md'>Discover who we are and be part of our <span className='font-bold text-accent-500'>JOURNEY</span></p>
        </div>
        ...
        <div className="flex-1">
          ...
          <StickyScrollItem>
            <div className="flex flex-col justify-center h-full gap-5">
              <h2 className='text-2xl font-bold'>DMRS <span className='text-primary-300'>Australia</span></h2>
          ...
          <StickyScrollItem>
            <div className="flex flex-col justify-center h-full gap-5">
              <h2 className='text-2xl font-bold'>DMRS <span className='text-primary-300'>Thailand</span></h2>
          ...
          <StickyScrollItem>
            <div className="relative flex flex-col justify-center h-full gap-5">
              <h2 className='relative text-2xl font-bold text-primary-300 after:absolute after:top-[15px] after:left-[231px] after:w-3 after:bg-white after:h-3'>Specialization</h2>

              <div ref={animatedCircle} className="animated-circle absolute top-[194px] left-[232.3px] h-[0.65rem] rounded-full aspect-square bg-primary-300"></div>
